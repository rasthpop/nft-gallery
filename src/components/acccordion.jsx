...
export default function Accordion(props){
    ...
    return(
        <div id={props.title} className="">
            <div onClick={() => {setOpen(!open)}} className="cursor-pointer mb-4 rounded-full flex text-xl py-2 px-6 bg-[#251607] text-[#FFF0E1]" key={props.title}>
                ...
                {search_arr.map(attr => (
                    <div key={attr} className={`grid overflow-hidden  ${
                        ...
                        <div className="flex items-center mb-8">
                            ...
                            <span className="overflow-hidden text-xl ml-4 mr-auto pb-1">{attr}</span>
